...
const String logInScreenRoute = "authentication";
...
const String navScreenRoute = "NavigatorScreen";
const String page1ScreenRoute = "Page1Screen";
const String page2ScreenRoute = "Page2Screen";
const String page3ScreenRoute = "Page3Screen";
